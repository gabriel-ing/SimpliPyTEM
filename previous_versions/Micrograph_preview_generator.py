...
parser.add_argument('--motioncor', help='To use motioncor on the videos in the folder use this flag')
...
if args.motioncor:
    ...
    dm_vids = [x for x in dm_files if os.path.getsize(x)>115082888]
    for file in dm_vids:
        outfile_aligned = motioncorrect_video
        Generate_preview_dm(outfile_aligned)
